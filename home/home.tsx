...
import { SafeTop } from './ui/safe-top';

// Importa los componentes traducidos
import CreateCourseDialog from '@/home/courses/create_course_dialog';
import JoinCourseDialog from '@/home/courses/join_course_dialog';
import CourseCard from './home/course_card';
import CreateCourseCard from './home/create_course_card';
import EvaluationListCard from './home/evaluation_list_card';
import JoinCourseCard from './home/join_course_card';
        ...
        <ScrollView horizontal style={{ height: 180 }}>
          {profCourses.map((ci, idx) => (
            <CourseCard 
              ...
              onPress={() => router.push({ pathname: '/courses/[id]' as any, params: { id: ci.course.id } })} 
            />
          ))}
